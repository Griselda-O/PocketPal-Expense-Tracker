...
class UserApi {
  ...
  static const MessageCodec<Object?> pigeonChannelCodec = _UserApiCodec();

  Future<PigeonUserDetails> getUserDetails() async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.pocketpal.UserApi.getUserDetails';
  ...
  Future<void> registerUser(PigeonUserDetails details) async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.pocketpal.UserApi.registerUser';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
